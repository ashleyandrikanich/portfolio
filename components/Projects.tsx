...
function ProjectImage({ project }: { project: (typeof projects)[number] }) {
  ...
  return (
    <div
      className={`relative aspect-[16/10] w-full shrink-0 bg-[#3d1219] lg:aspect-auto lg:w-72 ${
        imageOnRight
          ? "border-b border-border/60 lg:border-b-0 lg:border-l lg:border-border/60"
          : "border-b border-border/60 lg:border-b-0 lg:border-r lg:border-border/60"
      }`}
    >
      <Image
        src={project.image}
